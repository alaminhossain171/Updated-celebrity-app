          ...
          <>
               <ScrollView style={styles.container}>
                    <View style={styles.ContainerCard}>
                         <Text style={styles.TextHeder}>Language</Text>
                    </View>
                    ...
                    <View style={styles.ContainerCard2}>
                         ...
                         <View style={styles.ContentX}>
                              <View>
                                   <Text style={styles.Edit}>Arabic</Text>
                              </View>
                              <View>
                         ...
                         <View style={styles.ContentX}>
                              <View>
                                   <Text style={styles.Edit}>Bengli</Text>
                              </View>
                              <View>
                         ...
                         <View style={styles.ContentX}>
                              <View>
                                   <Text style={styles.Edit}>English</Text>
                              </View>
                              <View>
                         ...
                         <View style={styles.ContentX}>
                              <View>
                                   <Text style={styles.Edit}>Hindi</Text>
                              </View>
                              <View>
